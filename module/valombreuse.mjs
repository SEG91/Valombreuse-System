...
import { ValombreuseActor } from "./documents/actor.mjs";
import { ValombreuseItem } from "./documents/item.mjs";
// Import sheet classes.
import { ValombreuseActorSheet } from "./sheets/actor-sheet.mjs";
import { ValombreuseItemSheet } from "./sheets/item-sheet.mjs";
// Import helper/utility classes and constants.
import { preloadHandlebarsTemplates } from "./helpers/templates.mjs";
import { VALOMBREUSE } from "./helpers/config.mjs";
...
async function createItemMacro(data, slot) {
  ...
  if (!macro) {
    macro = await Macro.create({
      ...
      img: item.img,
      command: command,
      flags: { "valombreuse.itemMacro": true }
    });
  }
